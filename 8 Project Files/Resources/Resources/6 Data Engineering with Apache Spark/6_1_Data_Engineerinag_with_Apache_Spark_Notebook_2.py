...
# MAGIC %run "/Workspace/Resources/6 Data Engineering with Apache Spark/6_Data_Engineering_with_Apache_Spark"
...
# MAGIC FROM course_training_catalog.bronze_olist.products;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM product_cast;
...
# MAGIC %sql
# MAGIC SELECT * FROM products_enriched;
...
# MAGIC SELECT * 
# MAGIC FROM course_training_catalog.bronze_olist.orders;
...
# MAGIC %sql
# MAGIC SELECT * FROM v2_orders_dates;
...
# MAGIC %sql
# MAGIC SELECT * FROM v3_orders_timeparts;
...
# MAGIC %sql
# MAGIC SELECT * FROM v7_orders_quality;
