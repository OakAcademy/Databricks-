...
# MAGIC %sql
# MAGIC SELECT * FROM course_training_catalog.bronze_olist.order_payments;
...
# MAGIC
# MAGIC FROM course_training_catalog.bronze_olist.order_payments;
...
# MAGIC %sql
# MAGIC SELECT * FROM payments_flagged;
...
# MAGIC %sql
# MAGIC SELECT * FROM course_training_catalog.bronze_olist.order_reviews;
...
# MAGIC
# MAGIC FROM course_training_catalog.bronze_olist.order_reviews;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM reviews_stage;
...
# MAGIC %sql
# MAGIC SELECT * FROM reviews_valid_dedup;
...
# MAGIC %sql
# MAGIC SELECT * FROM reviews_enriched;
...
# MAGIC %sql
# MAGIC DESCRIBE EXTENDED silver_olist.order_reviews;course_training_catalog.silver_olist.order_itemscourse_training_catalog.silver_olist.order_reviews

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM course_training_catalog.bronze_olist.geolocation;
...
# MAGIC %sql
# MAGIC SELECT * FROM course_training_catalog.bronze_olist.product_category_name_translation;
...
# MAGIC FROM course_training_catalog.bronze_olist.product_category_name_translation;
