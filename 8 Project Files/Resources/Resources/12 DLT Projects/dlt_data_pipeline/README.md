...
This folder defines all source code for the 'dlt_data_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_dlt_data_pipeline.py" to get familiar with the syntax.
